...
-- Tabla categories (como en Sequelize)
...
-- Tabla products (como en Sequelize)
...
-- Tabla pedidos (como en Sequelize)
...
-- Tabla detalle_pedidos (como en Sequelize)
